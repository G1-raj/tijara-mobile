class IndividualListingModel {
    ...
    factory IndividualListingModel.fromJson(Map<String, dynamic> json){ 
        return IndividualListingModel(
...
// import 'package:tijara/models/listings/listing_data_model.dart';
...
//       return IndividualListingModel(
//           success: json["success"],
//           data: json["data"] == null ? null : ListingDataModel.fromJson(json["data"]),
//           status: json["status"],
//           error: json["error"]
//       );
//   }
